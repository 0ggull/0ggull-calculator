  ...
  return (
    <label
      ...
      className={`flex items-start gap-3 p-3 rounded-xl border transition-all duration-150 cursor-pointer
        ${checked
          ? "bg-brand-50 dark:bg-brand-900/40 border-brand-300 dark:border-brand-600"
    ...
    >
      <input
        ...
        className="mt-0.5 w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-brand-600 focus:ring-brand-500 dark:bg-gray-700"
      />
